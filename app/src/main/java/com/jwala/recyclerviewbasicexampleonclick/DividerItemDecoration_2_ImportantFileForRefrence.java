...
public class DividerItemDecoration_2_ImportantFileForRefrence  extends RecyclerView.ItemDecoration {

    private Drawable mDivider;

    public DividerItemDecoration_2_ImportantFileForRefrence(Drawable divider) {
        mDivider = divider;
    }
